                      ...
                      ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_4$3, [
                          ...
                          ($options.isDropdownArray(column))
                            ? (vue.openBlock(), vue.createElementBlock("select", {
                                ...
                                vue.createElementVNode("option", _hoisted_7$2, vue.toDisplayString($options.getPlaceholder(column)), 1 /* TEXT */),
                                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(column.filterOptions.filterDropdownItems, (option, i) => {
                                  return (vue.openBlock(), vue.createElementBlock("option", {
                                    key: i,
                                    value: option
                                  }, vue.toDisplayString(option), 9 /* TEXT, PROPS */, _hoisted_8$2))
                                }), 128 /* KEYED_FRAGMENT */))
                          ...
                          ($options.isDropdownObjects(column))
                            ? (vue.openBlock(), vue.createElementBlock("select", {
                                ...
                                vue.createElementVNode("option", _hoisted_10$2, vue.toDisplayString($options.getPlaceholder(column)), 1 /* TEXT */),
                                (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(column.filterOptions.filterDropdownItems, (option, i) => {
                                  return (vue.openBlock(), vue.createElementBlock("option", {
                                    key: i,
                                    value: option.value
                                  }, vue.toDisplayString(option.text), 9 /* TEXT, PROPS */, _hoisted_11$1))
                                }), 128 /* KEYED_FRAGMENT */))
            ...
            ? (vue.openBlock(), vue.createElementBlock("th", {
                ...
                ($options.isSortableColumn(column))
                  ? (vue.openBlock(), vue.createElementBlock("button", {
                      ...
                      vue.createElementVNode("span", _hoisted_6$2, " Sort table by " + vue.toDisplayString(column.label) + " in " + vue.toDisplayString($options.getColumnSortLong(column)) + " order ", 1 /* TEXT */)
